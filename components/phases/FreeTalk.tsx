...
export default function FreeTalk() {
  ...
  const { selectedTheme, inlineStyles } = useThemedStyles()
        ...
        <div className="p-6 bg-white border-t border-gray-100">
          <div className="flex gap-3">
            ...
            <ThemedButton
              ...
              className="px-6 py-3 rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed self-end"
              variant="default"
            >
            ...
            {showContinueButton && !showMagicButton && (
              ...
              >
                <ThemedButton
                  ...
                  variant="secondary"
                  className="inline-flex items-center gap-2 px-8 py-3 rounded-lg font-medium transition-all hover:shadow-lg transform hover:scale-105"
                >
                  洞察を精製する
