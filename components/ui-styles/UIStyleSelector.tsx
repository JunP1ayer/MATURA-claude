...
export const UIStyleSelector: React.FC<UIStyleSelectorProps> = ({
  ...
  return (
    <div className={cn("w-full max-w-7xl mx-auto p-6", className)}>
                ...
                <Card className={cn(
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="relative">
                      ...
                      {/* Hover Overlay */}
                      {isHovered && (
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex items-end justify-center pb-6 transition-opacity duration-300">
                          <Button 
                            size="sm"
      ...
      {selectedStyle && (
        <div className="mt-12 text-center transition-opacity duration-300">
