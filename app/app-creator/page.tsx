...
import { Loader2, Sparkles, Palette, Code, Eye, Wand2, Figma } from 'lucide-react';
          ...
          <Card className="max-w-4xl mx-auto shadow-xl">
            ...
            <CardContent className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <Textarea
                  id="app-idea"
                  placeholder="例: ブログ記事を管理できるアプリを作りたい。記事にはタイトル、内容、作成者、公開状態が必要です。カテゴリ別に整理できると良いです。"
                  value={userInput}
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center gap-3 mb-2">
                          <div className="flex gap-1">
                            <div className={`w-4 h-4 rounded-full bg-${theme.colors.primary}`} />
                            <div className={`w-4 h-4 rounded-full bg-${theme.colors.secondary}`} />
                            <div className={`w-4 h-4 rounded-full bg-${theme.colors.accent}`} />
                          </div>
              ...
              <div className="space-y-4 border-t pt-6">
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    id="useFigma"
                    checked={useFigma}
                    onChange={(e) => setUseFigma(e.target.checked)}
                    className="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500"
                  />
                  <Label htmlFor="useFigma" className="text-lg font-semibold flex items-center gap-2">
                ...
                {useFigma && (
                  <div className="space-y-2">
                    <Label htmlFor="figma-url" className="text-sm text-gray-600">
                      FigmaファイルURL（オプション）
                    </Label>
                    <Input
                      id="figma-url"
                    ...
                    <p className="text-xs text-gray-500">
                      ※ URLを指定しない場合はデフォルトのデザインシステムを使用します
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="flex gap-3">
                <Button 
                  ...
                  disabled={(isGenerating || isGeneratingFigma) || !userInput.trim()}
